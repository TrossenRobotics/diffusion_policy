...
class TrossenArmController(mp.Process):
    def __init__(self, 
        ...
        # TODO(abhi): please understand this clearly? also why not duration?
        example = {
    ...
    def run(self):
        ...
        try:
            ...
            while keep_running:
                ...
                # t_loop_start: perf_counter, used only for frequency regulation
                ...
                if self.verbose:
                    print(f"[TrossenArmController] Actual frequency {1/(time.perf_counter() - t_loop_start):.1f} Hz")
        finally:
            try:
                follower_driver.set_all_modes(trossen_arm.Mode.position)
